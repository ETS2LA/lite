# Made by Michel Le Bihan (mimi89999 https://github.com/mimi89999)
    ...
    def __init__(self):
        ...
        if system == "Windows":
            ...
            try:
                ...
                raise RuntimeError(f"ETS2/ATS is not running (Currently game needs to be running for app to start THIS IS TEMPORARY)")
            try:
