...
ButtonColor = (42, 42, 42) if Theme == "Dark" else (236, 236, 236)
ButtonHoverColor = (47, 47, 47) if Theme == "Dark" else (231, 231, 231)
ButtonSelectedColor = (28, 28, 28) if Theme == "Dark" else (250, 250, 250)
ButtonSelectedHoverColor = (28, 28, 28) if Theme == "Dark" else (250, 250, 250)
