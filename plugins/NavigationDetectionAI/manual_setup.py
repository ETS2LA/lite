...
exampleimage = cv2.imread(path + "assets/setupexample.png")
...
cv2.resizeWindow(example_window_name, round(exampleimage_width), round(exampleimage_height))
...
map_topleft = Get("NavigationDetectionAI", "MapTopLeft", "unset")
map_bottomright = Get("NavigationDetectionAI", "MapBottomRight", "unset")
...
if map_topleft == None:
    ...
    Set("NavigationDetectionAI", "MapTopLeft", map_topleft)
if map_bottomright == None:
    ...
    Set("NavigationDetectionAI", "MapBottomRight", map_bottomright)
...
while True:
    ...
    if get_map_topleft == False and get_map_bottomright == False:
    ...
    if button_finish_setup_pressed == True:
        if map_topleft == None or map_bottomright == None:
    ...
    if button_zoom_in_hovered == False and button_zoom_out_hovered == False and button_new_screenshot_hovered == False and button_reset_hovered == False and button_finish_setup_hovered == False and get_map_topleft_hovered == False and get_map_bottomright_hovered == False:
    ...
    if left_clicked == True and get_map_topleft == False and get_map_bottomright == False and any_button_hovered == False:
